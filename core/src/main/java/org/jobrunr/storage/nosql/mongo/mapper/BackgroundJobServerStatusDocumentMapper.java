...
import static org.jobrunr.storage.StorageProviderUtils.BackgroundJobServers.FIELD_DELETE_FAILED_JOBS_AFTER;
...
public class BackgroundJobServerStatusDocumentMapper {
    ...
    public Document toInsertDocument(BackgroundJobServerStatus serverStatus) {
        ...
        document.put(FIELD_DELETE_FAILED_JOBS_AFTER, serverStatus.getDeleteFailedJobsAfter().toString());
    ...
    public BackgroundJobServerStatus toBackgroundJobServerStatus(Document document) {
        ...
        return new BackgroundJobServerStatus(
                ...
                Duration.parse(document.getString(FIELD_DELETE_FAILED_JOBS_AFTER)),
