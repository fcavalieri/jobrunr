...
public class ForcedGsonBackgroundJobContainer extends AbstractBackgroundJobContainer {

    private final GenericContainer mongoContainer;
    private final Network network;

    public ForcedGsonBackgroundJobContainer(GenericContainer mongoContainer, Network network) {
        super("jobrunr-e2e-force-gson:1.0");
