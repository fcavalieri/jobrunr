...
public class ForcedJacksonBackgroundJobContainer extends AbstractBackgroundJobContainer {

    private final GenericContainer mongoContainer;
    private final Network network;

    public ForcedJacksonBackgroundJobContainer(GenericContainer mongoContainer, Network network) {
        super("jobrunr-e2e-force-jackson:1.0");
